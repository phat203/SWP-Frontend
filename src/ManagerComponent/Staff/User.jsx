...
const User = () => {
  ...
  const validate = () => {
    ...
    tempErrors.fullname = !formValue.fullname ? "Full Name is required." : startsWithSpace(formValue.fullname) ? "Full Name cannot start with a space." : "";
    tempErrors.username = !formValue.username ? "Username is required." : startsWithSpace(formValue.username) ? "Username cannot start with a space." : "";
    ...
    tempErrors.email = !formValue.email ? "Email is not valid." : startsWithSpace(formValue.email) ? "Email cannot start with a space." : !/.+@.+\..+/.test(formValue.email) ? "Email is not valid." : "";
    tempErrors.gender = !formValue.gender ? "Gender is required." : startsWithSpace(formValue.gender) ? "Gender cannot start with a space." : "";
    tempErrors.role = !formValue.role ? "Role is required." : startsWithSpace(formValue.role) ? "Role cannot start with a space." : "";
