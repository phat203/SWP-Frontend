    ...
    <Box className="navbar-container">
          ...
          <React.Fragment key={item}>
            {item === "BuyBack" ? (
              <>
                ...
                >
                  <MenuItem
                    onClick={() => window.location.href = "/staff/jewelry/buy"}
                    sx={{
                      "&:hover": {
                  ...
                  <MenuItem
                    onClick={() => window.location.href = (`/staff/jewelry/exchange`)}
                    sx={{
                      "&:hover": {
                        backgroundColor: grey[200],
                      },
      ...
      <div className="navbar-icons">
        <div className="avatar-container flex gap-6">
          {auth.user ? (
            <>
              <button onClick={handleAvatarClick} className="flex items-center gap-2 hover:bg-cyan-50 p-2">
                <svg
          ...
          <IconButton
            id="cart"
            onClick={() => (window.location.href = "/staff/jewelry/cart")}
          >
